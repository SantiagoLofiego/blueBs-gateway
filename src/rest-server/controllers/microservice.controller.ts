...
export const addMicroservice = async (req: Request<{ service: ServiceInstance }>, res: Response, next: NextFunction) => {
    try {
...
export const getServiceUrl = (req: Request<{ serviceName: string }>, res: Response, next: NextFunction) => {
    try {
